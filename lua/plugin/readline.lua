...
---@param str string
---@return boolean
local function str_isempty(str) return str:gsub('%s+', '') == '' end
...
---@return boolean
local function last_line() return fn.mode() == 'c' or line '.' == line '$' end

---Check if current line is the first line
---@return boolean
local function first_line() return fn.mode() == 'c' or line '.' == 1 end

---Check if cursor is at the end of the line
---@return boolean
local function end_of_line() return get_current_col() == #get_current_line() + 1 end

---Check if cursor is at the start of the line
---@return boolean
local function start_of_line() return get_current_col() == 1 end
