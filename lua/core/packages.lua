...
local function setup_lazy(module_names)
  local config = {
    ...
    ui = {
      ...
      icons = {
        cmd = vim.trim(PREF.icons.ui.Cmd),
        ...
        import = vim.trim(PREF.icons.ui.ArrowLeft),
        keys = vim.trim(PREF.icons.ui.Keyboard),
        lazy = PREF.icons.ui.Sleep .. ' ',
        loaded = vim.trim(PREF.icons.ui.CircleFilled),
        not_loaded = vim.trim(PREF.icons.ui.CircleEmpty),
        plugin = vim.trim(PREF.icons.kinds.Package),
        runtime = vim.trim(PREF.icons.ui.Neovim),
        source = vim.trim(PREF.icons.ui.Vim),
